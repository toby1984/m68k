...
public class CPUTest extends TestCase
{
    ...
    public void testMOVEMToMemoryLong()
    {
        ...
        LOG.info( "Address: "+Misc.hex(adr)  );
        LOG.info( "Expected address: "+Misc.hex(adrExpected)  );
        execute(cpu->{},
                "lea "+adr+",a3",
                "move.l #1,d0",
                "move.l #2,d1",
...
C — Always cleared.
    ...
    {
        LOG.info( "USP = "+Misc.hex(USERMODE_STACK_PTR) );
 ...
 */
    ...
    public void testBRA() {
        LOG.info( "Program start is at "+Misc.hex(PROGRAM_START_ADDRESS) );
...
1010: 00 06 ..
                                     ...
                                     String... additional)
    {
        ...
        LOG.info( "USERMODE_STACK_PTR = "+Misc.hex(USERMODE_STACK_PTR) );
        ...
        LOG.info(  Memory.hexdump(PROGRAM_START_ADDRESS,executable,0,executable.length)  );
        ...
        {
            LOG.info( "***" );
            LOG.info( "* Binary dumped to "+DEBUG_BINARY.getAbsolutePath() );
            LOG.info( "***" );
    ...
    protected final class ExpectionBuilder
    {
        ...
        private ExpectionBuilder assertHexEquals(String msg,int expected,int actual)
        {
            if ( expected != actual )
            {
                LOG.info( "EXPECTED: "+hex32(expected) );
                LOG.info( "ACTUAL  : "+hex32(actual) );
                fail(msg);
            }
            return this;
        }

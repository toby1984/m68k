...
import de.codesourcery.m68k.emulator.memory.MemoryBreakpoint;
...
public class MemoryBreakpointsWindow extends AppWindow implements Emulator.IEmulatorStateCallback,
        ITickListener
{
    private static final Logger LOG = LogManager.getLogger( MemoryBreakpointsWindow.class.getName() );
